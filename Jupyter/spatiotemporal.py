# -*- coding: utf-8 -*-
"""Copy of spatiotemporal-colab.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1OBZh9kjTn2KaD9UWdXQvCStJrIgVylfF
...
# For colab, we need to install IMP, gnuplot, and Ghostscript
# Install IMP stable release
!add-apt-repository -y ppa:salilab/ppa
!apt install imp
import sys, os, glob
imp_pypath = os.path.dirname(glob.glob('/usr/lib/python*/dist-packages/IMP')[0])
if 'PYTHONPATH' in os.environ:
    os.environ['PYTHONPATH'] += ":" + imp_pypath
else:
    os.environ['PYTHONPATH'] = imp_pypath
sys.path.append(imp_pypath)
