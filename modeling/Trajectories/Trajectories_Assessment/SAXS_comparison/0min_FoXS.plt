...
plot 'snapshot1_0min_0min_exp.fit' u 1:2 t 'Experimental' lc rgb '#333333' pt 6 ps 0.8 , 'snapshot1_0min_0min_exp.fit' u 1:4 t 'snapshot1_0min χ^2 = 0.874724' w lines lw 2.5 lc rgb '#FF0000', 'snapshot2_0min_0min_exp.fit' u 1:4 t 'snapshot2_0min χ^2 = 42.9744' w lines lw 2.5 lc rgb '#0000FF', 'snapshot3_0min_0min_exp.fit' u 1:4 t 'snapshot3_0min χ^2 = 107.343' w lines lw 2.5 lc rgb '#00FF00'
