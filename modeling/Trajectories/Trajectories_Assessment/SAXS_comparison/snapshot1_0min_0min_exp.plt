set terminal png enhanced; set output "snapshot1_0min_0min_exp.png";
...
plot f(x) notitle lc rgb '#333333', 'snapshot1_0min_0min_exp.fit' u 1:(($2-$4)/$3) notitle w lines lw 2.5 lc rgb '#e26261'
...
plot 'snapshot1_0min_0min_exp.fit' u 1:2 t 'Experimental' lc rgb '#333333' pt 6 ps 0.8, 'snapshot1_0min_0min_exp.fit' u 1:4 t 'FoXS χ^2 = 0.875' w lines lw 2.5 lc rgb '#e26261'
unset multiplot
reset
set terminal postscript eps size 3.5,2.62 color enhanced solid linewidth 2.5 font 'Helvetica,22'; set output "snapshot1_0min_0min_exp.eps";
...
plot 'snapshot1_0min_0min_exp.fit' u 1:2 t 'Experimental' lc rgb '#333333' pt 6 ps 0.8, 'snapshot1_0min_0min_exp.fit' u 1:4 t 'FoXS {/Symbol c}^2 = 0.875' w lines lw 2.5 lc rgb '#e26261'
unset multiplot
reset
