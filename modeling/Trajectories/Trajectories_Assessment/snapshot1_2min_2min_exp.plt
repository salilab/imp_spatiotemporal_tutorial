...
plot 'snapshot1_2min_2min_exp.fit' u 1:2 t 'Experimental' lc rgb '#333333' pt 6 ps 0.8, 'snapshot1_2min_2min_exp.fit' u 1:4 t 'FoXS χ^2 = 2.09' w lines lw 2.5 lc rgb '#e26261'
unset multiplot
reset
...
plot 'snapshot1_2min_2min_exp.fit' u 1:2 t 'Experimental' lc rgb '#333333' pt 6 ps 0.8, 'snapshot1_2min_2min_exp.fit' u 1:4 t 'FoXS {/Symbol c}^2 = 2.09' w lines lw 2.5 lc rgb '#e26261'
unset multiplot
reset
